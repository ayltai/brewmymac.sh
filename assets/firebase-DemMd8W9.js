import{o as ue}from"./vendor-BmfRSFhQ.js";(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},e=new Error().stack;e&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[e]="1983957a-0fac-423f-b204-1315dba2339e",t._sentryDebugIdIdentifier="sentry-dbid-1983957a-0fac-423f-b204-1315dba2339e")}catch{}})();var J={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(It(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function It(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const j="@firebase/app",Q="0.9.27";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(t){v(new I("platform-logger",e=>new yt(e),"PRIVATE")),v(new I("heartbeat",e=>new tn(e),"PRIVATE")),y(j,Q,t),y(j,Q,"esm2017"),y("fire-js","")}rn("");var sn="firebase",on="10.8.0";/**
 * @license
...
//# sourceMappingURL=firebase-DemMd8W9.js.map
